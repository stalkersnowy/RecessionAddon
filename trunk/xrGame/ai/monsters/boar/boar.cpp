...
void CAI_Boar::Load(LPCSTR section)
{
	...
	anim().AddAnim(eAnimLieIdle,			"lie_sleep_",			-1, &velocity_none,		PS_LIE, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r"	);
	...
	anim().AddAnim(eAnimRun,				"stand_run_fwd_",		-1,	&velocity_run,		PS_STAND, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
	...
	anim().AddAnim(eAnimLookAround,		"stand_idle_",			 2, &velocity_none,		PS_STAND, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
...
//	anim().AddAnim(eAnimAttackRun,		"stand_run_attack_",	-1, &velocity_run,		PS_STAND, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");

	anim().AddAnim(eAnimRunTurnLeft,	"stand_run_look_left_",	 -1, &velocity_run,	PS_STAND, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
	anim().AddAnim(eAnimRunTurnRight,	"stand_run_look_right_", -1, &velocity_run,	PS_STAND, g_bUseHitFX, "fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
