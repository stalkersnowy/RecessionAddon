...
{ 
	...
	m_can_throw_grenades			= !!READ_IF_EXISTS(pSettings,r_bool,section,"can_throw_grenades",FALSE);
}
...
#include "date_time.h"
LPCSTR CAI_Stalker::visual_name	(CSE_Abstract *server_entity) 
{
	if (m_already_dead)
