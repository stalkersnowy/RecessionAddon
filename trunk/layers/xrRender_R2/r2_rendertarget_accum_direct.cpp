...
#			define FOURCC_GET1  MAKEFOURCC('G','E','T','1') 
		...
		if ( RImplementation.o.advancedpp&&(ps_r_sun_shafts>0))
			accum_direct_volumetric	(sub_phase, Offset, m_shadow, L_dir);
	}
}
...
void CRenderTarget::accum_direct_volumetric	(u32 sub_phase, const u32 Offset, const Fmatrix &mShadow, const Fvector L_dir)
{
